<header class="bg-dark border-bottom border-primary">
    <div class="container d-flex align-items-center justify-content-between py-2">
        ...
        <!-- Iconos del header -->
        <div class="d-flex">
            <a href="#" class="HeaderIcon mx-2">
                <img src="./Views/Resources/User_Icon.png" alt="User Icon" class="img-fluid" style="width: 32px;">
            </a>
            <a href="#" class="HeaderIcon mx-2">
                <img src="./Views/Resources/Shop-Cart_Icon.png" alt="Shop Cart Icon" class="img-fluid" style="width: 32px;">
            </a>
        </div>
    </div>
</header>
