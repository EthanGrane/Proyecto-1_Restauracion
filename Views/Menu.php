<?php
include_once(__DIR__ . "Framework/DAO/DAO.php");
include_once(__DIR__ . "Framework/ViewSystem/ViewSystem.php");
include_once(__DIR__ . "Framework/CookieHandler/CookieHandler.php");
